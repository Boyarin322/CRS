...
const Ads = (props:className) => {
    ...
    return (
            ...
            <div className={`col-span-1 grid grid-rows-2 gap-4 ${className}`}>
                <div className="row-span-1 bg-gray-100 p-4 rounded-md">
                    <h2 className="text-lg font-medium text-gray-800 mb-4">Sponsored</h2>
                    <a href="#" className="block relative">
                        ...
                        />
                        <div className="absolute bottom-0 left-0 w-full h-20 rounded-b-lg bg-gradient-to-t from-gray-800 opacity-90"></div>
                        <div className="absolute bottom-0 left-0 w-full h-20 rounded-b-lg px-4 pb-2">
                            ...
                            <p className="text-sm text-gray-400">Discover new products and brands</p>
                        </div>
                    </a>
                </div>
                <div className="row-span-1 bg-gray-100 p-4 rounded-md">
                    <a href="#" className="block relative">
                        ...
                        <div className="absolute bottom-0 left-0 w-full h-20 rounded-b-lg px-4 pb-2">
                            ...
                            <p className="text-sm text-gray-400">Book your next adventure today</p>
                        </div>
                    </a>
                </div>
            </div>
